...
func (unzip *Unzipfile) Utf8ToGBK(text string) (string, error) {
...
func (unzip *Unzipfile) WriteNewFile(fpath string, in io.Reader, fm os.FileMode) error {
...
func (unzip *Unzipfile) fileExists(name string) bool {
	_, err := os.Stat(name)
	return !os.IsNotExist(err)
}

func (unzip *Unzipfile) mkdir(dirPath string) error {
